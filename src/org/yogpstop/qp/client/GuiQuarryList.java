...
public class GuiQuarryList extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.controlList.add(new GuiButton(TileQuarry.openQuarryGui, this.width / 2 - 125, this.height - 26, 250, 20, StatCollector.translateToLocal("gui.done")));
        this.controlList.add(new GuiButton(TileQuarry.fortuneTInc + this.targetid - 1, this.width * 2 / 3 + 10, 50, 100, 20, StatCollector
        ...
        this.controlList.add(this.delete = new GuiButton(TileQuarry.fortuneRemove + this.targetid - 1, this.width * 2 / 3 + 10, 110, 100, 20, StatCollector
